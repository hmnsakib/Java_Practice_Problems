...
public class ClassObject4 {
    ...
    public static void main(String[] args) {
        ...
        ClassObject4 student1 = new ClassObject4();
        ClassObject4 student2 = new ClassObject4();
        ClassObject4 student3 = new ClassObject4();

        student1.set("Jasim", 36, 3.9f);
        student2.set("Jubayer", 17, 3.4f);
        student3.set("Sakib", 16, 3.4f);
        
        student1.dis(student1.name, student1.roll, student1.cg);
        student2.dis(student2.name, student2.roll, student2.cg);
        student3.dis(student3.name, student3.roll, student3.cg);
    }
}
